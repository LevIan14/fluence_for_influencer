...
class InfluencerPortfolio extends StatelessWidget {
  ...
  InfluencerPortfolio({super.key, required this.portfolio, required this.portfolioBloc});
      ...
      child: Stack(
        children: [ 
          Align(
            ...
            child: IconButton(icon: const Icon(Ionicons.ellipsis_vertical_outline, color: Constants.grayColor), iconSize: 22.0, 
              onPressed: () { 
